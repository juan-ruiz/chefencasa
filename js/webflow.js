...
Webflow.require('ix').init([
  {"slug":"slide-out-zoom-icon-on-load","name":"Slide out zoom icon on Load","value":{"style":{"opacity":0,"x":"0px","y":"40px","z":"0px"},"triggers":[]}},
  {"slug":"slide-out-lightbox-overlay-on-load","name":"Slide out Lightbox Overlay on Load","value":{"style":{"opacity":0},"triggers":[]}},
  {"slug":"slide-in-lightbox-content-on-hover","name":"Slide in Lightbox content on hover","value":{"style":{},"triggers":[{"type":"hover","selector":".lightbox-overlay","descend":true,"stepsA":[{"opacity":1,"transition":"opacity 500ms ease 0ms"}],"stepsB":[{"opacity":0,"transition":"opacity 500ms ease 0ms"}]},{"type":"hover","selector":".zoom-icon","descend":true,"preserve3d":true,"stepsA":[{"wait":100},{"opacity":1,"transition":"transform 500ms ease 0ms, opacity 500ms ease 0ms","x":"0px","y":"0px","z":"0px"}],"stepsB":[{"opacity":0,"transition":"transform 500ms ease 0ms, opacity 500ms ease 0ms","x":"0px","y":"40px","z":"0px"}]}]}}
]);
